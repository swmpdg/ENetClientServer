...
void protobuf_AssignDesc_ServerInfo_2eproto() {
  ...
  static const int ServerInfo_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ServerInfo, ipaddress_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ServerInfo, hostname_),
  };
...
void protobuf_AddDesc_ServerInfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020ServerInfo.proto\022\016sv_cl_messages\"1\n\nSe"
    "rverInfo\022\021\n\tipAddress\030\001 \002(\t\022\020\n\010hostName\030"
    "\002 \002(\t", 85);
...
#ifndef _MSC_VER
const int ServerInfo::kIpAddressFieldNumber;
...
ServerInfo::ServerInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:sv_cl_messages.ServerInfo)
}
...
ServerInfo::ServerInfo(const ServerInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:sv_cl_messages.ServerInfo)
}
...
ServerInfo::~ServerInfo() {
  // @@protoc_insertion_point(destructor:sv_cl_messages.ServerInfo)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:sv_cl_messages.ServerInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:sv_cl_messages.ServerInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:sv_cl_messages.ServerInfo)
  return false;
#undef DO_
}
...
void ServerInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:sv_cl_messages.ServerInfo)
  // required string ipAddress = 1;
  if (has_ipaddress()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->ipaddress().data(), this->ipaddress().length(),
  ...
  // @@protoc_insertion_point(serialize_end:sv_cl_messages.ServerInfo)
}

::google::protobuf::uint8* ServerInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:sv_cl_messages.ServerInfo)
  // required string ipAddress = 1;
  if (has_ipaddress()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->ipaddress().data(), this->ipaddress().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sv_cl_messages.ServerInfo)
  return target;
}
