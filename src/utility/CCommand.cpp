...
{
	//Don't forget to point past the space after the command if there are any arguments.
	return m_uiCommandNameLength ? &m_szCommandString[ m_uiCommandNameLength + ( m_iArgc > 1 ? 1 : 0 ) ] : "";
}
